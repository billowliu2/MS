...
using MS.Lib.Data.Abstractions.SqlQueryable;
using MS.Lib.Data.Core.SqlQueryable;
using System;
...
namespace MS.Lib.Data.Core
{
    public class DbSet<TEntity> : IDbSet<TEntity> where TEntity : IEntity, new()
    {
        ...
        #endregion ==QuerySingleOrDefault==
